...
Recent Updates Since Third Submission:
Community Forum : Fully functional forum page allowing text posts, image uploads, and threaded replies.
Enhanced with image upload support, stored and rendered as base64.

About Page Navigation Links:
Added clear links and buttons in about.html to assist users in quickly navigating to desired pages: Directory, Job Board, Events, Community, etc.
Improves portal usability and flow.

Modifications:
Login Page: Improved form design and slight UI modifications for better user interaction.
CSS Enhancements: Adjusted styles across the project for consistent element alignment.
Improved spacing, padding, and responsive support in key components such as directory table, forms, and feature cards.
Alumni Directory: 
Included additional alumni records with expanded data fields.
Enhanced user search experience with better filtering based on multiple profile attributes.
Forum Page: is updated for posting new posts and logic is rewritten

Code Maintenance: 
Added thorough inline comments in JavaScript files explaining:
API request flows
